...
To pose this as boundary value problem,
...
we get
\begin{align}
	A(\theta) &= \frac{1}{v} \frac{1 + (u/v) \cos \theta}{1 - (u/v)^2} \\
...
to get $T = lv / (v^2 - u^2)$
which is identical to \ref{ans}.

\section*{Discussion}

\begin{figure}
	\begin{tabular}{cc}
	\includegraphics[width=0.48\linewidth]{plotT.png} &
	\includegraphics[width=0.48\linewidth]{plotA.png}
	\end{tabular}
\end{figure}
